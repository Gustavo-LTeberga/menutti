...
<body class="color-two d-flex justify-content-center align-items-center vh-100">
    <main class="container login-card mx-auto">
        <form class="h-100  row">
            <!-- topo do card -->
            <div class="col-12 col-md-6">

                <a href="index.php" class="text-black fs-1 ps-2">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <div class="pb-md-4 h-75 d-flex flex-column justify-content-center align-items-center">
                    <span class="fw-bold fs-2">Admin</span>
